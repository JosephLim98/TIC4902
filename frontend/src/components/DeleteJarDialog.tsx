...
export function DeleteJarDialog({ jar, onClose, onSuccess }: Props) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center" aria-modal="true" role="dialog">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-2xl border border-zinc-200 bg-white p-6 shadow-2xl">
        ...
        <h2 className="text-base font-semibold text-zinc-900">Delete this JAR?</h2>
        <p className="mt-1.5 text-sm text-zinc-500">
          <span className="font-mono font-medium text-zinc-800">{jar.name}</span>{' '}
